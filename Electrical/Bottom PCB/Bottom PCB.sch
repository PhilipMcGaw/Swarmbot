...
Wire Wire Line
	8550 5900 8400 5900
Text GLabel 9800 6450 0    50   Input ~ 0
SwFL
...
Wire Wire Line
	6000 1900 6000 1950
Text GLabel 11250 3300 2    49   Input ~ 0
RX
Text GLabel 11250 3200 2    49   Input ~ 0
TX
Wire Wire Line
	10950 3200 11250 3200
Wire Wire Line
...
U 1 1 5E39190F
P 11050 5050
F 0 "#PWR057" H 11050 4800 50  0001 C CNN
...
U 1 1 5E3921D9
P 9100 5050
F 0 "#PWR056" H 9100 4800 50  0001 C CNN
...
Wire Wire Line
	9800 5750 9950 5750
Text GLabel 9800 6050 0    49   Input ~ 0
DATA
...
F 1 "22k" V 10245 650 50  0000 C CNN
...
U 1 1 5ECFA0AC
P 8350 2200
F 0 "#PWR0102" H 8350 2050 50  0001 C CNN
...
F 1 "10uF" H 8442 2255 50  0000 L CNN
F 2 "Capacitor_SMD:C_1206_3216Metric_Pad1.42x1.75mm_HandSolder" H 8350 2300 50  0001 C CNN
...
U 1 1 5ECFB59E
P 8700 2300
F 0 "C19" H 8792 2346 50  0000 L CNN
F 1 "100pF" H 8792 2255 50  0000 L CNN
F 2 "Capacitor_SMD:C_1206_3216Metric_Pad1.42x1.75mm_HandSolder" H 8700 2300 50  0001 C CNN
...
F 1 "+3.3V" H 8715 2373 50  0000 C CNN
...
U 1 1 5ECFC360
P 8350 2400
F 0 "#PWR0104" H 8350 2150 50  0001 C CNN
...
U 1 1 5ECFC83C
P 8700 2400
F 0 "#PWR0105" H 8700 2150 50  0001 C CNN
...
$EndComp
$Comp
L esp32-wrover:ESP32-WROVER U9
U 1 1 5EE8EC9D
P 10100 3550
F 0 "U9" H 10075 4887 60  0000 C CNN
F 1 "ESP32-WROVER" H 10075 4781 60  0000 C CNN
F 2 "esp32-wrover:ESP32-WROVER" H 10550 3250 60  0001 C CNN
...
U 1 1 5F0E70CE
P 5200 5950
F 0 "U10" H 5200 7231 50  0000 C CNN
F 1 "MCP23017_SO" H 5200 7140 50  0000 C CNN
F 2 "Package_SO:SOIC-28W_7.5x17.9mm_P1.27mm" H 5400 4950 50  0001 L CNN
F 3 "http://ww1.microchip.com/downloads/en/DeviceDoc/20001952C.pdf" H 5400 4850 50  0001 L CNN
	1    5200 5950
	1    0    0    -1  
$EndComp
$Comp
